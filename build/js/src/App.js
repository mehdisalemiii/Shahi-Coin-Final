...
const Earn_js_1 = __importDefault(require("./Assets/Earn.js"));
const Boost_1 = __importDefault(require("./Assets/Boost"));
const Frens_1 = __importDefault(require("./Assets/Frens"));
function App() {
    ...
    const [showBoosts, setShowBoosts] = (0, react_1.useState)(false);
    const openBoosts = () => {
        setShowBoosts(!showBoosts);
    };
    const [showFrens, setShowFrens] = (0, react_1.useState)(false);
    const openFrens = () => {
                    ...
                    react_2.default.createElement("div", { className: "flex-grow flex items-center max-w-60 text-sm" },
                        react_2.default.createElement("div", { className: "w-full bg-[#fad258] py-4 rounded-2xl flex justify-around" },
                            react_2.default.createElement("button", { className: "flex flex-col items-center gap-1", onClick: openFrens },
                                showFrens && react_2.default.createElement(Frens_1.default, { showFrens: showFrens, openFrens: openFrens, onBoostPurchase: (cost) => setPoints(points - cost) }),
                            ...
                            react_2.default.createElement("button", { className: "flex flex-col items-center gap-1", onClick: openEarn },
                                showTasks && react_2.default.createElement(Earn_js_1.default, { showTasks: showTasks, openEarn: openEarn, onTaskComplete: (reward) => setPoints(points + reward) }),
                            ...
                            react_2.default.createElement("div", { className: "h-[48px] w-[2px] bg-[#fddb6d]" }),
                            react_2.default.createElement("button", { className: "flex flex-col items-center gap-1", onClick: openBoosts },
                                showBoosts && react_2.default.createElement(Boost_1.default, { showBoosts: showBoosts, openBoosts: openBoosts, onBoostPurchase: (cost) => setPoints(points - cost) }),
